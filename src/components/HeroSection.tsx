      ...
      <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12 lg:py-20">
        <div className="grid lg:grid-cols-[1.1fr_0.8fr] gap-8 lg:gap-0 items-center">
          <div className="text-left space-y-6">
            ...
            <h1 className="w-full max-w-none text-3xl sm:text-4xl lg:text-5xl xl:text-6xl font-inter font-bold text-[#FDCF12] leading-[1.65] tracking-[0.1em] translate-y-4">
              Marooned on a side of a road, at Home or Work?
            </h1>

            <div className="space-y-2 translate-y-6">
            ...
            <div className="flex flex-col sm:flex-row gap-4 pt-4 translate-y-8">
            ...
            <p className="text-md font-inter font-regular text-[#FBB038] flex items-center gap-2 pt-2 translate-y-10">
